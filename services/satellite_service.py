    ...
    layers = [
        {
            ...
            "url_template": f"https://tile.openweathermap.org/map/clouds_new/{{z}}/{{x}}/{{y}}.png?appid={OPENWEATHER_API_KEY}" if OPENWEATHER_API_KEY else "https://tilecache.rainviewer.com/v2/radar/nowcast/256/{z}/{x}/{y}/2/1_1.png",
        ...
        },
        {
            ...
            "url_template": f"https://tile.openweathermap.org/map/pressure_new/{{z}}/{{x}}/{{y}}.png?appid={OPENWEATHER_API_KEY}" if OPENWEATHER_API_KEY else None,
            "attribution": "Map data &copy; OpenWeatherMap",
            "opacity": 0.50,
            "update_interval": "30 minutes",
        ...
        },
        {
            ...
            "url_template": f"https://tile.openweathermap.org/map/humidity_new/{{z}}/{{x}}/{{y}}.png?appid={OPENWEATHER_API_KEY}" if OPENWEATHER_API_KEY else None,
            "attribution": "Map data &copy; OpenWeatherMap",
            "opacity": 0.50,
            "update_interval": "30 minutes",
        ...
        },
        {
            ...
            "type": "openweathermap",
            "layer_name": "snow_new",
            "url_template": f"https://tile.openweathermap.org/map/snow_new/{{z}}/{{x}}/{{y}}.png?appid={OPENWEATHER_API_KEY}" if OPENWEATHER_API_KEY else None,
            "attribution": "Snow data &copy; OpenWeatherMap",
            "opacity": 0.65,
            "update_interval": "1 hour",
        ...
        },
        {
            ...
            "category": "Oceanic",
            "type": "nasa",
            "url_template": "https://gibs.earthdata.nasa.gov/wmts/epsg3857/best/GHRSST_L4_MUR_Sea_Surface_Temperature/default/2026-08-01/GoogleMapsCompatible_Level9/{z}/{y}/{x}.png",
        ...
        },
        {
            ...
            "category": "Oceanic",
            "type": "nasa",
            "url_template": "https://gibs.earthdata.nasa.gov/wmts/epsg3857/best/OSCAR_L4_OC_third-degree/default/2026-08-01/GoogleMapsCompatible_Level9/{z}/{y}/{x}.png",
